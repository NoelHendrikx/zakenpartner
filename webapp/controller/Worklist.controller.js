...
sap.ui.define([
		...
		return BaseController.extend("nl.peppieportals.overzichttijdgegevens.controller.Worklist", {
			...
			onSelectRadio : function(oEvt){
				this.getModel("helper").setProperty("/filter/intern", oEvt.getSource().getText() === "Interne");
			},
			...
			onSearch : function (oEvent) {
				if (oEvent.getParameters().refreshButtonPressed) {
					...
					if (sQuery && sQuery.length > 0) {
						aTableSearchState = [new Filter("zoeknaam", FilterOperator.Contains, sQuery)];
					}
			...
			_showObject : function (oItem) {
				this.getRouter().navTo("object", {
					objectId: oItem.getBindingContext("helper").getProperty("zoeknaam")
				});
			},
